...
COMPANIES = [
    ...
    {"seg":"gestao", "name":"GRTS Digital",      "subseg":"Gestão de Relações Trabalhistas e Sindicais (RTS)", "porte":"Startup",             "loc":"São Paulo - SP",        "fund":"2019",  "presenca":"Unilever, Coca-Cola, Vivo, Burger King, C&A | 29 colaboradores", "receita":"R$ 3,4M aporte", "nota":"Ecossistema SaaS de digitalização de RTS: gestão de CCTs, IA 'Norma' para análise de cláusulas, assembleias virtuais e data intelligence. Integração com HCM via parceria LG. Prêmio inovação RH 2025. R$3,4M Fundo GovTech KPTL.", "alerta":"Portfólio KPTL", "url":"https://grtsdigital.com.br", "isNew":False},
