...
CHANGELOG = [
    {
        "version": "v18", "date": "21/05/2026",
        "items": [
            "Minuta.Tech adicionada (proc) — IA de minutas jurídicas exclusivamente para o setor público: Procuradorias (PGE/PGM), Defensorias, TCs, MP e Judiciário; base RAGJUR 22M+ decisões, API Local (dados não saem da rede), especialidade LGPD pública",
        ]
    },
    {
        "version": "v17", "date": "21/05/2026",
        "items": [
            "Assesi adicionada (gestao) — suíte SaaS de portais governamentais e transparência: aSiteGov, aLegislativo, aCidadão, aDiário, aOuvidoria, CarteirinhaGov; 600+ municípios, 27 estados, 14 anos, Fortaleza CE",
        ]
    },
    {
    ...
    },
    {
        ...
        "items": [
            "SentinelX adicionada (segpub) — maior plataforma de reconhecimento facial com IA da AL, motor do Smart Sampa SP: 40K+ câmeras, 2.718+ foragidos capturados, R$40M em novas tecnologias planejado",
            "Camerite adicionada (segpub) — IA para videomonitoramento multimarcas (facial + placas), rede colaborativa, modelo franquia, integrada ao Smart Sampa e Guardião 7L (Sete Lagoas MG)",
            "Monuv adicionada (segpub) — VMS em nuvem + IA, principal provedor do Smart Sampa (14.000+ câmeras), detecção facial abr/2026, 98%+ acurácia",
            "Zaelo adicionada (lic) — buy-side compras públicas: Loja Pública Gestor + Sentinela (auditoria IA), 170+ órgãos, 10K+ servidores, até 45% economia, Itajaí SC",
            "Licito.guru adicionada (lic) — IA buy-side para órgãos: gera ETP, DFD, TR, Edital, Contrato; clientes Pref. SP, Gov. PR, Gov. SC, TJ, MP, Pref. Curitiba; Florianópolis SC",
            "Munitax adicionada (fiscal) — inteligência tributária municipal completa: IPTU, ISS, ITBI, dívida ativa, cruzamento com Receita Federal e juntas comerciais; CEO Harrison Leite",
            "Leme adicionada (educ) — gestão educacional orientada por dados/VAAR para secretarias: 15+ municípios, 100K+ alunos, +26% desempenho em 4 meses, dispensa de licitação disponível",
            "Layers adicionada (educ) — SuperApp escolar: 7.600 escolas públicas + 1.800 privadas, R$21M pré-série A (fundo canadense set/2025), valuation R$120M, R$1Bi+ transacionado",
        ]
    },
    {
    ...
    },
    {
        ...
        "items": [
            "Licitagram adicionada (lic) — 1º SO de IA Multi-Agente para Licitações da AL: 200k+ licitações/mês, R$1T+ oportunidades, 14 módulos IA",
            "Licitei adicionada (lic) — sell-side PMEs, R$3,5M aporte (Thompson Participações), 4.000+ usuários, 206k+ editais, PNCP integrado",
            "Proesc adicionada (educ) — edtech amapaense com vertical Proesc Gov já implantada na Prefeitura de Macapá (105 escolas, Alerta Escolar)",
            "Colab: atualizada com Colab Gov.AI (AWS Bedrock, out/2025, 94% aceleração), rodada US$10M+ para 2026, total captado ~R$25M, novos clientes TCU + Diadema + Rio das Ostras + Duque de Caxias",
            "GRTS Digital: sede corrigida para Salvador - BA; GRTS Contábil lançada (12 contratos nas primeiras 3 semanas), co-investidor Aleve Legal Tech, meta R$25M faturamento até 2027",
            "Fundo GovTech: aporte Finep + Fapesp (out/2025) → R$105,7M total (de R$49M); meta R$150M em 2026; parceria Prodesp For Startups (SP)",
            "M&A Valid × MITRA: Valid adquire 51% da MITRA (gestão municipal integrada 'Governo Único para um Cidadão Único') — 1,7M+ cidadãos, SP e RJ",
        ]
    },
    {
        "version": "v12", "date": "06/05/2026",
        "items": [
            "Atualização massiva: site oficial (url) adicionado a todas as 68 empresas do radar",
            "Atuação, segmento e dados validados com base nos sites oficiais de cada empresa",
            "ImpulsoGov: porte corrigido para ONG/Não-lucrativa (410+ municípios, missão social)",
            "Attus: rebrand de 'Attornatus' confirmado (dez/2023), URL attus.ai, IA generativa + automações",
            "MinutaIA: fundação corrigida para fev/2024 (não 2025)",
            "Geopixel: sede corrigida para São José dos Campos SP (Parque Tecnológico SJC)",
            "IPQ Tecnologia: sede corrigida para Porto Alegre RS (Tecnopuc/PUCRS), 25+ anos",
            "GovTools: sede corrigida para Gravataí RS",
            "UpCities: sede corrigida para Vitória ES",
            "PGMNET: sede corrigida para Campos dos Goytacazes RJ",
            "StartGov: sede corrigida para Imperatriz MA",
            "CERURB: sede corrigida para Teresina PI",
            "TUXTU: sede corrigida para Macapá AP",
            "Vivenda: 6.500+ reformas realizadas, R$54M+ gerenciados, COHAB-SP parceiro",
            "SmartCityTec: URL smartcity.tec.br, membro oficial FIWARE Foundation",
        ]
    },
    {
...
COMPANIES = [
    ...
    {"seg":"fiscal", "name":"Munitax",           "subseg":"Inteligência Tributária Municipal Completa", "porte":"Startup / Scale-up", "loc":"Brasil", "fund":"N/D", "presenca":"Municípios de qualquer porte | cobertura IPTU, ISS, ITBI, dívida ativa", "receita":"N/D", "nota":"Plataforma completa de inteligência tributária para municípios: IPTU, ISS, ITBI, dívida ativa, notificações automatizadas e processos administrativos fiscais end-to-end. Cruzamento automático com bases da Receita Federal e juntas comerciais para enriquecimento cadastral e detecção de inconsistências tributárias. MuniAcademy: maior plataforma de capacitação em tributação municipal do Brasil com 320+ publicações e 140h de conteúdo. CEO: Harrison Leite (doutor em Direito Tributário, autor de 30+ livros). Combinação rara de tecnologia + doutrina jurídica tributária.", "alerta":"Watch — fiscal municipal", "url":"https://munitax.com.br", "isNew":True},
    {"seg":"fiscal", "name":"LICI GovTech",      "subseg":"Governança Municipal Baseada em Dados / ODS", "porte":"Startup",             "loc":"Belo Horizonte - MG",   "fund":"2018",  "presenca":"1.000+ gestores formados | SEDE-MG, FINEP, PNUD, UNESCO, ALMG", "receita":"N/D", "nota":"GovTech de governança orientada a dados com metodologia CHESI (registrada no INPI): 160+ indicadores ODS monitorados em tempo real, conectando projetos a financiamento público. Produz Relatórios Locais Voluntários para Agenda 2030. Coordena GT Cidades Inteligentes da ALMG.", "alerta":"", "url":"https://licigovtech.com.br", "isNew":False},
    {"seg":"fiscal", "name":"Quasar",            "subseg":"Alvará Digital e Licenciamento de Empresas Municipal", "porte":"Startup",             "loc":"Belo Horizonte - MG",   "fund":"2019",  "presenca":"MG, RO, PE, MT | 480+ municípios via Jucemg/SINAL", "receita":"N/D", "nota":"Sistema de gestão de licenciamento e abertura de empresas, com alvarás digitais via QR Code e integração REDESIM. Parceiro estadual da Jucemg para o sistema SINAL (480+ municípios de MG). Apoio Seed-MG e AWS. Reduz prazo de emissão de alvarás em 90%. BrazilLAB 2023.", "alerta":"Watch — expansão estadual Jucemg", "url":"https://quasar.srv.br", "isNew":False},
    {"seg":"gestao", "name":"GESUAS",            "subseg":"Gestão do SUAS / Assistência Social", "porte":"Startup / PME",       "loc":"Viçosa - MG",           "fund":"2008",  "presenca":"Centenas de municípios | CRASs e CREASs", "receita":"N/D", "nota":"SaaS de gestão do SUAS com Prontuário Digital integrado ao CadÚnico, planos PAIF/PAEFI/PIA, vigilância socioassistencial georreferenciada e relatórios MDS. 56 colaboradores. Líder IE GovTech 2020. Vertical exclusivo sem concorrente direto.", "alerta":"Vertical exclusivo mapeado", "url":"https://gesuas.com.br", "isNew":False},
    {"seg":"gestao", "name":"Prosas",            "subseg":"Gestão de Editais e Investimento Social", "porte":"Startup",             "loc":"Belo Horizonte - MG",   "fund":"2014",  "presenca":"13k+ editais | institutos e fundações corporativas", "receita":"R$4M (KPTL)", "nota":"Maior base de editais do terceiro setor no Brasil. Plataforma para criação de editais, inscrições online, pareceristas e monitoramento de projetos. Venture Round out/2024. Portfólio Fundo GovTech KPTL. 51 funcionários.", "alerta":"Portfólio KPTL", "url":"https://prosas.com.br", "isNew":False},
    {"seg":"gestao", "name":"Lemobs",            "subseg":"Gestão Urbana Integrada / Smart Cities", "porte":"Startup",             "loc":"Rio de Janeiro - RJ",   "fund":"2015",  "presenca":"79k+ pontos monitorados | prefeituras e Petrobras", "receita":"N/D", "nota":"GovTech de cidades inteligentes com SIGELU (limpeza urbana), fiscalização móvel, gestão nutricional escolar e saúde. Primeiro contrato pelo Marco Legal das Startups. Origem COPPE/UFRJ. Selo GovTech BrazilLAB.", "alerta":"", "url":"https://lemobs.com.br", "isNew":False},
    {"seg":"segpub", "name":"SentinelX",        "subseg":"Reconhecimento Facial com IA / Segurança Pública Urbana", "porte":"Scale-up", "loc":"São Paulo - SP", "fund":"N/D", "presenca":"40K+ câmeras | 2.718+ foragidos capturados | 3.650+ presos em flagrante (2025) | 48+ projetos em andamento", "receita":"N/D", "nota":"Maior plataforma de reconhecimento facial com IA da América Latina. Motor tecnológico por trás do Smart Sampa (SP): sistema de videomonitoramento integrado da cidade de São Paulo. 2.718+ criminosos foragidos capturados e 3.650+ pessoas presas em flagrante em 2025. R$40M de investimento em novas tecnologias planejado. 48+ projetos em andamento no Brasil. CEO: Cristian Aquino. Reconhecimento facial em tempo real em escala urbana.", "alerta":"🔥 Deal — Smart Sampa", "url":"https://sentinelx.com.br", "isNew":True},
    {"seg":"segpub", "name":"Camerite",          "subseg":"IA para Videomonitoramento Multimarcas (Facial + Placas)", "porte":"Startup / Scale-up", "loc":"Brasil", "fund":"N/D", "presenca":"Sete Lagoas MG (Guardião 7L) | Smart Sampa SP | modelo franquia nacional", "receita":"N/D", "nota":"Plataforma de IA para videomonitoramento compatível com câmeras de qualquer fabricante. Plataforma Cortex com IA 'Hórus': reconhecimento facial, leitura de placas, detecção de comportamentos suspeitos e rede colaborativa entre câmeras de diferentes entes. Modelo de franquia para expansão nacional. Cases: Sete Lagoas MG (Projeto Guardião 7L) e integração ao Smart Sampa (SP). Reduz custo de implantação por não exigir troca de hardware existente.", "alerta":"Watch — expansão franquias", "url":"https://camerite.com", "isNew":True},
    {"seg":"segpub", "name":"Monuv",             "subseg":"VMS em Nuvem + IA / Videomonitoramento Urbano", "porte":"Startup / Scale-up", "loc":"Brasil", "fund":"N/D", "presenca":"14.000+ câmeras no Smart Sampa SP (principal provedor) | planos a partir de R$900/mês", "receita":"N/D", "nota":"VMS (Video Management System) 100% em nuvem com IA embarcada. Principal fornecedor do Smart Sampa: 14.000+ câmeras integradas ao sistema de videomonitoramento da cidade de São Paulo. Detecção de pessoas por IA lançada abr/2026 (98%+ acurácia, reduz 100x falsos alarmes). Plataforma agnóstica de hardware — integra câmeras de qualquer fabricante. Modelo SaaS acessível com planos a partir de R$900/mês, escalável do pequeno município à metrópole. Obs.: Monuv faz detecção de objetos/faces mas não reconhecimento facial biométrico (diferente da SentinelX).", "alerta":"🔥 Deal — Smart Sampa", "url":"https://monuv.com.br", "isNew":True},
    {"seg":"segpub", "name":"Sipremo",           "subseg":"Previsão de Desastres / ClimateTech", "porte":"Startup",             "loc":"Ribeirão Preto - SP",   "fund":"~2018", "presenca":"Defesa Civil + seguros",  "receita":"R$200k (2022)",    "nota":"IA para previsão antecipada de desastres naturais com dados NASA e bases nacionais. Alerta SMS via Defesa Civil municipal. Selecionada COP26. Foco em mitigação de riscos climáticos e resiliência urbana.", "alerta":"Watch — clima/risco", "url":"https://sipremo.com.br", "isNew":False},
    {"seg":"segpub", "name":"i4Sea",             "subseg":"Previsões Microclimáticas / Portos e Energia", "porte":"Startup",             "loc":"Santos - SP",           "fund":"~2018", "presenca":"Portos, setor elétrico e renovável | Porto do Açu, Wilson Sons, Santos Brasil", "receita":"R$ 7,5M (Fundo GovTech)", "nota":"Plataforma i4cast® de decisão baseada em inteligência climática: previsões hiperlocais de mar e clima para operações portuárias, logística marítima e geração de energia renovável. Precisão 2x superior a previsões genéricas (94% acurácia no Porto do Açu). Captou R$7,5M do Fundo GovTech KPTL.", "alerta":"Portfólio KPTL", "url":"https://i4sea.com", "isNew":False},
    {"seg":"gestao", "name":"GRTS Digital",      "subseg":"Gestão de Relações Trabalhistas e Sindicais (RTS)", "porte":"Startup",             "loc":"Salvador - BA",         "fund":"2019",  "presenca":"Unilever, Coca-Cola, Vivo, Burger King, C&A | 29 colaboradores", "receita":"R$ 3,4M aporte (Fundo GovTech)", "nota":"Ecossistema SaaS de digitalização de RTS: gestão de CCTs, IA 'Norma' para análise de cláusulas, assembleias virtuais e data intelligence. Integração com HCM via parceria LG. Prêmio inovação RH 2025. R$3,4M Fundo GovTech KPTL (jun/2025). Lançou GRTS Contábil (12 contratos nas primeiras 3 semanas). Co-investidor Aleve Legal Tech. Meta: R$25M faturamento até 2027. CEO Uirá Menezes, sede Salvador BA.", "alerta":"Portfólio KPTL", "url":"https://grtsdigital.com.br", "isNew":False},
    {"seg":"segpub", "name":"IPQ Tecnologia",    "subseg":"Segurança Pública / TIC para Ambientes Críticos", "porte":"PME / Scale-up",      "loc":"Porto Alegre - RS",     "fund":"~2001", "presenca":"Nacional e internacional | órgãos públicos, presídios, hospitais, rodovias", "receita":"N/D", "nota":"25+ anos desenvolvendo e integrando soluções de TIC com IA e Analytics para segurança pública e ambientes críticos. Portfólio: videomonitoramento, controle de acesso, redes de dados públicas/privadas, infraestrutura para Defesa e Segurança. Atuação descentralizada com cobertura nacional.", "alerta":"", "url":"https://www.ipq.com.br", "isNew":False},
    {"seg":"segpub", "name":"Atech",             "subseg":"Comando & Controle / Defesa e Segurança Pública", "porte":"Médio Porte",         "loc":"São Paulo - SP",        "fund":"1999",  "presenca":"Nacional / Defesa, ATM, Segurança", "receita":"N/D", "nota":"Empresa do Grupo Embraer e Empresa Estratégica de Defesa (EED). Especialista em sistemas de missão crítica: Gerenciamento de Tráfego Aéreo (ATM), Comando & Controle (C4I), Gestão de UTM (drones), Segurança Pública, Sistemas Navais, Cibersegurança e Sistemas Embarcados. Certificações ISO internacionais.", "alerta":"", "url":"https://www.atech.com.br", "isNew":False},
    {"seg":"gestao", "name":"Governar",          "subseg":"ERP Municipal Integrado / SIAFIC Cloud", "porte":"Startup / Scale-up",  "loc":"Brasil",                "fund":"N/D",   "presenca":"Municípios de qualquer porte | SIAFIC + SIEDUC disponíveis", "receita":"N/D", "nota":"Suite ERP municipal integrada em nuvem com base de dados única: SIAFIC (financeiro/tributário), SIEDUC (educação), SISAÚDE e SIASOC. Conformidade SICONFI, SIOPE, e-Social, eSUS. Produto novo no mercado com proposta de stack completo integrado.", "alerta":"Watch — SIAFIC driver", "url":"https://www.governar.com.br", "isNew":False},
    {"seg":"fiscal", "name":"Qiatech",           "subseg":"Gestão de Convênios e Transferências Federais com IA", "porte":"Startup", "loc":"Brasil", "fund":"N/D", "presenca":"Municípios de qualquer porte | integra TransfereGov, Simec, Sismob, FNS, Sigcon", "receita":"N/D", "nota":"Primeiro sistema inteligente de gestão de convênios para prefeituras: unifica automaticamente TransfereGov, Simec, Sismob, FNS e Sigcon em painel único com IA. Kanban automático de diligências, alertas de prazo, monitoramento de certidões, previsão de repasses e elaboração de propostas com IA baseadas em cotações federais. Diferencial: deixa a IA captar e monitorar enquanto a prefeitura foca na execução.", "alerta":"Watch — convênios nicho virgem", "url":"https://www.qiatech.com.br", "isNew":False},
    {"seg":"fiscal", "name":"MuniScore",         "subseg":"Score Fiscal e Inteligência de Risco Municipal", "porte":"Startup", "loc":"Belo Horizonte - MG", "fund":"2026", "presenca":"100% dos 5.570 municípios brasileiros (dados) | B2B: fornecedores, bancos, seguradoras", "receita":"N/D", "nota":"Plataforma SaaS de score fiscal para municípios: nota de 0 a 1000 cruzando receita, despesa, endividamento e CAPAG (STN). Integra PNCP, TransfereGov, emendas parlamentares e PCA para identificar oportunidades de fornecimento. Assistente de IA com 4 perspectivas analíticas. Fundadores: Diego Barros (CEO) e Antonio Firmino (Chairman / Grupo Triasa). Planos a partir de R$97/mês.", "alerta":"Watch — dado fiscal municipal", "url":"https://muniscore.com.br", "isNew":False},
    {"seg":"gestao", "name":"Colab",             "subseg":"Participação Cidadã e Serviços Digitais Municipais", "porte":"Scale-up",         "loc":"São Paulo - SP",        "fund":"2013",  "presenca":"5 países | 1M+ cidadãos | Piauí, São Gonçalo, Santo André | Parceiro ONU-Habitat", "receita":"~R$25M total (MDIF+Luminate+EDP+KPTL)", "nota":"Plataforma multicanal (web, app, WhatsApp) de gestão de serviços digitais, participação cidadã e CRM governamental. IA digitaliza qualquer serviço público em minutos. Em 2025 viabilizou OP Digital do Piauí (273k participantes) com validação via Receita Federal e blockchain. Lançou Colab Gov.AI (AWS Bedrock, out/2025): 94% de aceleração na criação de serviços digitais, 500+ prompts em 14 dias. Novos clientes: TCU, Diadema, Rio das Ostras, Duque de Caxias. Rodada US$10M+ em curso para 2026. Portfólio KPTL+Cedro. Co-invest EDP Ventures + Luminate + MDIF.", "alerta":"Portfólio KPTL+Cedro", "url":"https://colab.com.br", "isNew":False},
    {"seg":"segpub", "name":"Fractal",           "subseg":"Previsão Hidroclimática / ClimateTech", "porte":"Startup / Scale-up",  "loc":"Florianópolis - SC",    "fund":"2010",  "presenca":"Defesa Civil SC | usinas hidrelétricas | Clientes: CPFL, Statkraft", "receita":"N/D (KPTL 2019)", "nota":"ClimaTech com plataforma SPEHC (SaaS) para previsões hidroclimáticas: antecipação de enchentes, gestão de barragens e operação de usinas. Integra múltiplos modelos, radares e dados em tempo real. Referência nacional na Defesa Civil de SC. Escritório também em Bauru/SP. Portfólio KPTL 2019.", "alerta":"Portfólio KPTL", "url":"https://fractaleng.com.br", "isNew":False},

    # ── SAÚDE PÚBLICA ──
    {"seg":"saude",  "name":"OM30",              "subseg":"Suite de Gestão Pública Municipal (Saúde, Educ, Dados, Frota)", "porte":"PME Estabelecida", "loc":"São Paulo - SP", "fund":"~2005", "presenca":"Municípios SP e outros estados", "receita":"N/D", "nota":"Suite modular de soluções estratégicas para gestão pública: Saúde Simples (prontuário, telemedicina, IA transcrevendo consultas), Educação Simples (gestão escolar), DadosGov Simples (BI exclusivo setor público), Mob Simples (gestão de frotas), Doc+ Simples (gestão documental), Outsourcing Simples (impressão) e Mentor Público (IEG-M com IA). 1º prontuário transcrito por IA da saúde pública do Brasil. Crescimento 40% na pandemia.", "alerta":"Target roll-up", "url":"https://om30.com.br", "isNew":False},
    {"seg":"saude",  "name":"Olostech",          "subseg":"Atenção Primária / APS",     "porte":"PME Estabelecida",    "loc":"Joinville - SC",        "fund":"1992",  "presenca":"100+ municípios",         "receita":"N/D",              "nota":"Pioneira SaaS cloud em APS (1998). 91% dos clientes melhoraram indicadores Previne Brasil 2023.", "alerta":"Target roll-up", "url":"https://olostech.com.br", "isNew":False},
    {"seg":"saude",  "name":"Vivver Sistemas",   "subseg":"APS + Educação Municipal",   "porte":"PME Estabelecida",    "loc":"Belo Horizonte - MG",   "fund":"1999",  "presenca":"Municípios MG + NE | Filiais SP e PB", "receita":"N/D", "nota":"26 anos de operação em saúde pública e gestão municipal. Selos Ouro/Prata Bora Vacinar (mar/2025). Cliente Sorocaba SP avançou C+ → B no IEGM 2025. Foco saúde pública + educação municipal integradas.", "alerta":"Target roll-up", "url":"https://vivver.com.br", "isNew":False},
    {"seg":"gestao", "name":"Pública Tecnologia","subseg":"ERP Municipal Full Suite",   "porte":"PME Estabelecida",    "loc":"Blumenau - SC",         "fund":"1993",  "presenca":"Municípios BR + Portugal + Venezuela", "receita":"N/D",  "nota":"ERP municipal full suite com 9 áreas: Financeira (contabilidade pública, NF-e), Tributária (ISS, IPTU), Gestão de Pessoas (RH, eSocial, ponto eletrônico), Saúde, Escolar, Assistência Social (SUAS), Administrativa (compras, frotas, patrimônio), Atendimento ao Cidadão (portal transparência, app Cidade Pública) e Gestão (BI, GED, PPA). 33 anos de atuação, 98 funcionários. Great Place to Work. Presença internacional: Portugal e Venezuela. Sede Blumenau/SC.", "alerta":"Target roll-up", "url":"https://publica.inf.br", "isNew":False},
    {"seg":"saude",  "name":"ImpulsoGov",        "subseg":"BI Preventivo para APS / Saúde Pública", "porte":"ONG / Não-lucrativa", "loc":"São Paulo - SP", "fund":"~2020", "presenca":"410+ municípios | 16M pessoas | 134k+ rotinas preventivas adicionais (2023)", "receita":"US$ 100k (Mulago Foundation)", "nota":"ONG com execução de startup focada em fechar gaps da atenção primária do SUS. Plataforma Impulso Previne: identifica pacientes em atraso em exames, vacinas e pré-natal e direciona agentes comunitários com listas priorizadas + SMS automático para cidadãos. Também atua em saúde mental (capacitação para depressão). Cofundada por ex-Harvard Kennedy School. Reconhecida pela CGU.", "alerta":"", "url":"https://impulsogov.org", "isNew":False},
    {"seg":"saude",  "name":"UpCities",          "subseg":"Integração e-SUS / Telecare","porte":"Startup",             "loc":"Vitória - ES",          "fund":"~2019", "presenca":"Municípios (expansão)",   "receita":"N/D",              "nota":"Integradora e-SUS/RNDS. Prontuário unificado, telecare. App offline para agentes comunitários de saúde.", "alerta":"", "url":"https://upcities.app", "isNew":False},
    {"seg":"saude",  "name":"ToGov",             "subseg":"Gestão de Saúde e Dados Municipais", "porte":"Startup", "loc":"Santa Luzia - MG", "fund":"2020", "presenca":"15+ municípios | 5 estados | MG, PR, ES, AL, PA", "receita":"N/D", "nota":"Soluções integradas para modernização municipal: Módulo Saúde (prontuários, regulação, vigilância sanitária) e Módulo Gestão de Dados (integração e consultoria em BI municipal). 100 Open Startups Top 10, Seed Gov, BrazilLAB, Centelha, Young Founders Program. +R$100M gerenciados em clientes.", "alerta":"", "url":"https://togov.com.br", "isNew":False},
    {"seg":"saude",  "name":"MedBolso",          "subseg":"Gestão de Escalas Médicas / Anti-fraude em Saúde","porte":"Startup", "loc":"Brasil", "fund":"~2020", "presenca":"50+ organizações | cooperativas, hospitais e grupos médicos", "receita":"N/D", "nota":"Aplicativo para gestão de escala médica em um só lugar: elimina planilhas, automatiza escalas de plantão e reduz glosas e fraudes administrativas. 50+ organizações economizando milhões. Top 30 Sebrae 2024. Acelerada GovTech Pará.", "alerta":"Watch — anti-fraude saúde", "url":"https://medbolso.com.br", "isNew":False},

    # ── EDUCAÇÃO PÚBLICA ──
    {"seg":"educ",   "name":"Portabilis",        "subseg":"Gestão Escolar e SUAS (SIE + Software Público)", "porte":"Scale-up / PME", "loc":"Içara - SC", "fund":"2009", "presenca":"100+ mun | 700k+ alunos | 200k+ famílias SUAS | 47k+ professores", "receita":"Aporte Yunus R$2M", "nota":"Mantenedora do i-Educar (software público federal MEC). Abriu o código-fonte do Pré-Matrícula Digital (PMD) em parceria com MEC, Fundação Lemann e MP-SC. Também atua em assistência social (SUAS): 50+ municípios, 200k+ famílias. Meta: 1,5M alunos até 2027. Parceria Portábilis+Educa Rios expandindo para AM.", "alerta":"Target / impacto", "url":"https://portabilis.com.br", "isNew":False},
    {"seg":"educ",   "name":"Vivver Sistemas",   "subseg":"Gestão Escolar (SIE)",       "porte":"PME Estabelecida",    "loc":"Belo Horizonte - MG",   "fund":"1999",  "presenca":"Municípios MG + NE",      "receita":"N/D",              "nota":"Cliente Sorocaba (SP): avançou C+ → B no IEGM 2025 (Saúde e Educação). 26 anos no segmento.", "alerta":"", "url":"https://vivver.com.br", "isNew":False},
    {"seg":"educ",   "name":"Educ21",            "subseg":"Gestão Escolar com IA",      "porte":"PME / Startup",       "loc":"Brasil",                "fund":"N/D",   "presenca":"Municípios",              "receita":"N/D",              "nota":"Gestão acadêmica, administrativa e financeira com IA integrada. Dados institucionais limitados — oportunidade de due diligence.", "alerta":"", "url":"https://educ21.com.br", "isNew":False},
    {"seg":"educ",   "name":"Geekie",            "subseg":"Aprendizagem IA / Ensino Híbrido", "porte":"Scale-up", "loc":"São Paulo - SP", "fund":"2011", "presenca":"5k+ escolas | 12M alunos | parceria MEC + Arco Educação", "receita":"N/D", "nota":"Plataforma Geekie One: solução completa de aprendizagem personalizada com IA para todos os segmentos (Infantil, Fund., Médio). BNCC-compliant. 415k+ alunos rede estadual SP (gratuito). Parceria MEC desde 2014 e Arco Educação+OpenAI. Brilhando Juntos: programa de marketing e retenção para escolas parceiras.", "alerta":"", "url":"https://geekie.com.br", "isNew":False},
    {"seg":"educ",   "name":"Educacross",        "subseg":"Gamificação + IA Educacional","porte":"Startup",             "loc":"Ribeirão Preto - SP",   "fund":"~2015", "presenca":"4M+ pessoas | 430M+ exercícios | 100% das redes parceiras melhoraram IDEB", "receita":"N/D", "nota":"10 anos de EdTech gamificada com IA adaptativa: avaliações digitais, jogos adaptativos e leitura Fi.Git.Al (físico+digital+social). Metodologia Flow + BNCC. Clientes: redes estaduais GO e BR, escolas públicas e privadas. 100% das redes parceiras melhoraram seu IDEB. Programas: Liga das Corujinhas, Alfabetização, Expedição, Olimpíadas.", "alerta":"", "url":"https://educacross.com.br", "isNew":False},
    {"seg":"educ",   "name":"ToGov",             "subseg":"Analytics Educacionais",     "porte":"Startup",             "loc":"Santa Luzia - MG",      "fund":"2020",  "presenca":"Municípios MG e outros",  "receita":"N/D",              "nota":"Monitoramento IDEB, IEGM, captação de recursos. Camada analítica sobre SIEs existentes. BrazilLAB 2023.", "alerta":"", "url":"https://togov.com.br", "isNew":False},
    {"seg":"educ",   "name":"i-Educar",          "subseg":"Open Source / Software Público","porte":"Software Público",  "loc":"Itajaí - SC (origem)", "fund":"2008",  "presenca":"80+ prefeituras | 2.050+ escolas | 500k+ alunos", "receita":"Gratuito", "nota":"Software público federal mantido pela Portabilis. Pré-Matrícula Digital PMD aberto ao público em 2025 (código no GitHub). Monte Alegre (RN) economizou R$2,4M. Parceria MEC + Fundação Lemann + MP-SC. Canoas RS referência em implementação.", "alerta":"Referência pública", "url":"https://ieducar.org", "isNew":False},
    {"seg":"educ",   "name":"Jovens Gênios",     "subseg":"EdTech Gamificada / IA Educacional","porte":"Startup",          "loc":"Rio de Janeiro - RJ",   "fund":"N/D",   "presenca":"5.000+ instituições | 100M+ questões | 400k+ conteúdos BNCC", "receita":"R$11,8M (Fundo GovTech)", "nota":"Maior plataforma de aprendizagem adaptativa gamificada do Brasil. 90% dos alunos em escolas públicas. +18% ganho de aprendizagem em poucos meses. Meta: 10M alunos até 2030. Rodada seed R$11,8M liderada pelo Fundo GovTech (KPTL+Cedro) com DOMO.VC, Criabiz Ventures e Rosey Ventures (Grupo Marista). Mar/2026. Parceiro Edebê Brasil (escolas Salesianas).", "alerta":"Portfólio KPTL+Cedro", "url":"https://jovensgenios.com", "isNew":False},
    {"seg":"educ",   "name":"Leme",              "subseg":"Gestão Educacional Orientada por Dados / VAAR para Secretarias", "porte":"Startup", "loc":"Brasil", "fund":"N/D", "presenca":"15+ municípios | 100K+ alunos | Mogi das Cruzes SP | São Vicente SP | Teresópolis RJ | Propriá SE", "receita":"N/D", "nota":"Plataforma de gestão educacional orientada por dados com metodologia MAPA (4 fases) e indicador VAAR (Valor Agregado com Ajuste de Risco). Foco em equidade racial e inclusão de alunos PPIs (Pretos, Pardos e Indígenas). +26% de desempenho médio em apenas 4 meses de implementação. 15+ municípios atendidos, 100K+ alunos impactados. Clientes de referência: Mogi das Cruzes SP, São Vicente SP, Teresópolis RJ, Propriá SE. Dispensa de licitação disponível para contratação simplificada.", "alerta":"Watch — municipal", "url":"https://leme.tec.br", "isNew":True},
    {"seg":"educ",   "name":"Layers",            "subseg":"SuperApp Escolar / Plataforma Educacional Unificada", "porte":"Scale-up", "loc":"São Caetano do Sul - SP", "fund":"N/D", "presenca":"7.600 escolas públicas (gratuito) | 1.800 escolas privadas | R$1Bi+ transacionado | 20+ ERPs integrados | 50+ soluções edtech parceiras", "receita":"R$21M (pré-série A, set/2025) | valuation R$120M", "nota":"SuperApp escolar que unifica comunicação, gestão e pagamentos em uma só plataforma. Para escolas públicas: totalmente gratuito (7.600 escolas). Para privadas: modelo SaaS premium (1.800 escolas). Ecossistema robusto: integra 20+ ERPs e 50+ soluções edtech parceiras. R$1Bi+ transacionado na plataforma. Aporte pré-série A de R$21M liderado por fundo canadense (set/2025), valuation R$120M. CEO: Danilo Yoneshige. Sede São Caetano do Sul SP. Diferencial: cobertura do setor público + privado com uma única plataforma.", "alerta":"🔥 Deal — aporte recente", "url":"https://layers.education", "isNew":True},
    {"seg":"educ",   "name":"Proesc",            "subseg":"Gestão Escolar com IA + Vertical Pública (Proesc Gov)", "porte":"Scale-up", "loc":"Macapá - AP", "fund":"N/D", "presenca":"3.000–3.500+ escolas | 5 países | 35+ redes parceiras BR | Prefeitura de Macapá (105 escolas)", "receita":"Maior rodada de invest. na Amazônia (Exame)", "nota":"Edtech amapaense fundada às margens do Rio Amazonas. Vertical pública Proesc Gov já implantada na Secretaria de Educação de Macapá: diário eletrônico com app offline, matrículas digitais, IDEB/VAAR e gestão da secretaria. Diferencial: Botão Alerta Escolar conecta as 105 escolas municipais à Guarda Civil Municipal. IA 'LIA' para decisões estratégicas nas secretarias. 3.000–3.500+ escolas parceiras (privadas + públicas), 5 países, 35+ redes pelo Brasil. Captou a maior rodada de investimento já realizada na Amazônia (Exame).", "alerta":"Watch — pública + Amazônia", "url":"https://www.proesc.com", "isNew":True},

    # ── IA PARA GOVERNO ──
    {"seg":"ia",     "name":"GovTools",          "subseg":"Agentes IA / WhatsApp Municipal", "porte":"Startup", "loc":"Gravataí - RS", "fund":"2024", "presenca":"200+ municípios", "receita":"Aporte Ventiur+DOMO", "nota":"Agentes IA via WhatsApp que operam sistemas municipais sem integração tradicional. 200+ municípios em menos de 12 meses. Modelo viral de adoção. Potencial alvo de aquisição.", "alerta":"M&A Watch", "url":"https://govtools.com.br", "isNew":False},
    {"seg":"ia",     "name":"Nuveo",             "subseg":"Document AI / Ultra OCR",    "porte":"Startup",             "loc":"SP / Campina Grande - PB","fund":"2016", "presenca":"Setor público e privado | financeiro, seguros, utilities, gov", "receita":"N/D", "nota":"Ultra OCR®: automação de análise de documentos com IA — classificação, extração de dados, comparação e validação em bases públicas. Gov Hub: onboarding de alunos, profissionais liberais e pessoas jurídicas. Human-in-the-loop para revisão de casos críticos. Presente em grandes empresas financeiras e setor público.", "alerta":"", "url":"https://nuveo.ai", "isNew":False},
    {"seg":"ia",     "name":"CPQD",              "subseg":"IA P&D / Gov Digital",       "porte":"Instituto P&D",       "loc":"Campinas - SP",         "fund":"N/D",   "presenca":"Governo Federal | MGI, telecom, utilities", "receita":"R$ 390M contrato", "nota":"Instituto de P&D referência em telecomunicações e tecnologias convergentes. Projeto INSPIRE com MGI (R$390M, 4 anos): IA personalizada para serviços de governo digital — assistentes virtuais de voz, recomendação e acessibilidade. Portfólio inclui IoT, Blockchain, IA, Conectividade Inteligente, OSS/BSS. Mais de 30 soluções comerciais.", "alerta":"Parceria estratégica MGI", "url":"https://cpqd.com.br", "isNew":False},
    {"seg":"segpub", "name":"Horus Smart Det.",  "subseg":"Monitoramento Aéreo / Fiscalização com IA", "porte":"Scale-up", "loc":"Florianópolis - SC", "fund":"2014", "presenca":"100+ clientes gov e privado | Florianópolis (Monitora Floripa), telco, energia", "receita":"N/D", "nota":"Plataforma de análise de imagens com IA para decisões inteligentes: sistema Monitora detecta obras irregulares e desmatamento via satélite + drones (identificação automática, 50% mais eficácia de fiscalização). Prêmio Connected Smart Cities 2021. Também atua em inspeção solar e telecom (Vivo, ENEL). CEO: Fabrício Hertz. Sede Parque Tecnológico ALFA Florianópolis.", "alerta":"", "url":"https://horus.global", "isNew":False},
    {"seg":"fiscal", "name":"Geopixel",          "subseg":"GeoInteligência Fiscal / Cadastro Imobiliário", "porte":"PME", "loc":"São José dos Campos - SP", "fund":"~2008", "presenca":"100+ municípios | clientes: Amparo SP, Teresópolis RJ, Guaratinguetá SP", "receita":"N/D", "nota":"18 anos como líder em geointeligência para prefeituras. Plataforma Geopixel Cidades integra geoprocessamento com IA para IPTU, ITBI, ISS e alvarás (digital e por QR Code). Módulos: SIG municipal integrado, monitoramento por satélite de alterações, mobilidade de campo e eventos ambientais. Reforma Tributária (LC 214/2025) cria janela de demanda direta e imediata.", "alerta":"Oportunidade fiscal 2025", "url":"https://geopixel.com.br", "isNew":False},
    {"seg":"segpub", "name":"Intelicity",        "subseg":"Gestão Urbana Preditiva / Pavimento e Zeladoria com IA", "porte":"Startup / Scale-up", "loc":"São Paulo - SP", "fund":"~2019", "presenca":"15M+ cidadãos | 8+ estados | São Paulo, Porto Alegre, Gravatá", "receita":"N/D", "nota":"Plataforma de gestão urbana inteligente com visão computacional embarcada em veículos: mapeia qualidade de pavimento, iluminação, encostas e ativos urbanos georreferenciados. Sistema Gaia (SP) apoia programa de recape. Dashboard preditivo com Machine Learning. Também gerencia zeladoria (OS) e intervenções de concessionárias. Integra portal do cidadão. 40+ tipos de ativos monitorados.", "alerta":"", "url":"https://intelicity.com.br", "isNew":False},
    {"seg":"proc",   "name":"Minuta.Tech",       "subseg":"IA Jurídica para Setor Público — Minutas, Pareceres e LGPD", "porte":"Startup", "loc":"Brasil", "fund":"N/D", "presenca":"Procuradorias (PGE/PGM) | Defensorias | Tribunais de Contas (TCU, TCEs, TCMs) | MP | Judiciário", "receita":"N/D", "nota":"Plataforma de IA de minutas jurídicas desenvolvida exclusivamente para o setor público. 5 modelos de IA combinados: Claude Opus + Gemini 3.1 Pro para o corpo das minutas; Gemini Deep Research + RAGJUR (base própria com 22M+ decisões do STF, STJ e TCs) para citações verificadas. Verticais: Procuradorias (PGE/PGM — pareceres, informações em mandados de segurança, contestações), Tribunais de Contas (relatórios, votos, pareceres, instruções), Judiciário (minutas de decisões, sentenças, acórdãos), Defensorias e MP. Especialidade em LGPD pública: pareceres, RIPD, políticas de privacidade e termos de uso para órgãos. API Local disponível (documentos nunca saem da rede interna). Planos institucionais com até 15 usuários. Contratável via licitação ou dispensa. Concorre diretamente com MinutaIA/jAI, com diferencial de foco exclusivo em setor público e base RAGJUR proprietária.", "alerta":"Watch — concorre com MinutaIA", "url":"https://minuta.tech", "isNew":True},
    {"seg":"proc",   "name":"MinutaIA (jAI)",    "subseg":"IA Jurídica / Judicial",     "porte":"Startup",             "loc":"Belo Horizonte - MG",   "fund":"fev/2024", "presenca":"7 tribunais | 100k+ usr", "receita":"N/D",              "nota":"10M+ minutas geradas. TJRS, STM, TRE-PB/BA, Tocantins. CNJ Resolução 615/2025. Exportou para a Argentina.", "alerta":"Watch — tração judicial", "url":"https://minutaia.com.br", "isNew":False},
    {"seg":"ia",     "name":"Tolky",             "subseg":"IA Atendimento ao Cidadão",  "porte":"Startup",             "loc":"Brasil",                "fund":"~2023", "presenca":"Contratos gov / CNJ",     "receita":"N/D",              "nota":"Multichannel (WhatsApp, chat, email) + processos end-to-end. ABES CSC 2025. Contrato CPSI CNJ.", "alerta":"Selecionada CPSI CNJ", "url":"https://tolky.com.br", "isNew":False},
    {"seg":"fiscal", "name":"Gove",              "subseg":"CRM Municipal / Cobrança & Automação via IA","porte":"Startup / Scale-up","loc":"São Paulo - SP",        "fund":"2018",  "presenca":"SP, MG, AM, BA, RJ, TO+", "receita":"R$ 8M (Astella)",  "nota":"Único CRM para setor público com chatbot WhatsApp verificado (login Gov.br), automação de serviços via IA e enriquecimento cadastral contínuo. Foco em arrecadação: cobrança ativa por WhatsApp/SMS/email/Domicílio Eletrônico, cruzamento com Receita Federal. CEO: Rodolfo Fiori (MIT). CTO: Dayanne Ramos. Cases: Salvador BA (R$29M recuperação crédito tributário), Araguaína TO (ROI 32x — R$300k→R$9,6M, 1º CPSI do país), Areal RJ (+135% arrecadação dívida ativa), Manaus AM, Pindamonhangaba SP. Prêmio InovaCidade 2023. Aporte Astella Series A (R$8M, 2020). BrazilLAB Turma 7.", "alerta":"M&A Watch — tração comprovada", "url":"https://gove.digital", "isNew":False},
    {"seg":"ia",     "name":"Inteligov",         "subseg":"Monitoramento Legislativo / Inteligência Regulatória","porte":"Startup / Scale-up",  "loc":"São Paulo - SP",        "fund":"2014",  "presenca":"100+ clientes | 27 estados + 1k+ mun. | +700 fontes", "receita":"N/D", "nota":"Pioneira em monitoramento automatizado de dados governamentais (Legislativo, Executivo, Judiciário). 4M+ proposições monitoradas, +700 fontes incluindo Diários Oficiais. IA com termômetro de aprovação de PLs (>98% acurácia). Única com 100% de cobertura das Assembleias Estaduais. Plataforma de Stakeholders para gestão de contatos e RIG. Ranking 100 Open Startups, Mapa GovTech. Cubo Itaú, Inovabra, Distrito.", "alerta":"Watch — inteligência regulatória", "url":"https://inteligov.com.br", "isNew":False},
    {"seg":"ia",     "name":"Datapolicy",        "subseg":"Inteligência Regulatória B2B / RelGov",             "porte":"Startup",             "loc":"Brasília - DF",         "fund":"N/D",   "presenca":"+80 clientes | 200+ fontes","receita":"N/D",              "nota":"Plataforma de inteligência regulatória voltada para corporações e escritórios de RelGov: monitora PLs, decretos, normas de agências reguladoras e órgãos de controle (federal, estadual, municipal). +16M proposições e atos indexados. Diferente da Inteligov (B2G): Datapolicy é B2B — vende para empresas que monitoram o governo. Portfólio Cedro Capital (FIP VBC) — disponível para M&A, sem mandatada.", "alerta":"M&A Watch — portfólio Cedro", "url":"https://datapolicy.co", "isNew":True},
    {"seg":"fiscal", "name":"Hub Esfera",        "subseg":"IA 3P para Gestão Municipal / Dashboard Analítico", "porte":"Startup",             "loc":"Porto Alegre - RS",     "fund":"N/D",   "presenca":"50+ municípios | 8 áreas da gestão pública", "receita":"N/D", "nota":"Plataforma de IA para gestão pública com metodologia exclusiva 3P: Preditiva (projeta receitas, saúde e matrículas), Preventiva (alertas automáticos de anomalias e contratos) e Prescritiva (sugere onde cortar custos, otimizar frota e compras). Dashboards interativos para todas as secretarias. Chat inteligente para consultas sobre dados oficiais da cidade. Marketplace de soluções parceiras integradas nativamente.", "alerta":"Watch", "url":"https://hubesfera.com.br", "isNew":False},
    {"seg":"ia",     "name":"Kinebot",           "subseg":"IA Ergonomia / Saúde do Trabalhador","porte":"Startup",          "loc":"Curitiba - PR",         "fund":"N/D",   "presenca":"29 países | Indústria + gov | 300k+ trabalhadores monitorados", "receita":"R$3M (Fundo GovTech)", "nota":"IA + visão computacional para análises ergonômicas e psicossociais automatizadas: reconhecimento de movimentos, quantificação de riscos biomecânicos e cronoanálise (Indústria 4.0). Resultados: -38% FAP, -30% afastamentos por DORT, análises 5x mais rápidas. Clientes: Marfrig, CNH Industrial, P&G, Electrolux, Vibra. 8º investimento Fundo GovTech (KPTL+Cedro), R$3M fev/2026. Campus da Indústria FIEP. 29 países.", "alerta":"Portfólio KPTL+Cedro", "url":"https://kinebot.com.br", "isNew":False},

    # ── PROCURADORIAS ──
    {"seg":"proc",   "name":"Attus",             "subseg":"IA Generativa + Automações para Procuradorias (PGE/PGM)","porte":"Scale-up","loc":"São Ludgero - SC (Grupo Eloware)","fund":"~2018","presenca":"PGE-SP, PGE-BA, PGE-PA, PGM-Palmas","receita":"SaaS Oracle Cloud","nota":"Rebrand de Attornatus (dez/2023) para Attus. IA generativa treinada exclusivamente na realidade de cada procuradoria: sínteses inteligentes de processos, geração de minutas, agente jurídico interativo. Centenas de automações em bastidores. Recuperação inteligente de Dívida Ativa com enriquecimento cadastral via Receita Federal. 4,3M+ processos analisados. 73% classificados automaticamente (98,5% acurácia). 642k+ peças geradas por IA. Referência nacional pós PGE-SP.", "alerta":"M&A Watch — líder do segmento", "url":"https://attus.ai", "isNew":False},
    {"seg":"proc",   "name":"Eicon / Giex",      "subseg":"Dívida Ativa / Execução Fiscal","porte":"PME",              "loc":"Brasil",                "fund":"N/D",   "presenca":"PGE e PGM — múltiplos estados","receita":"N/D",        "nota":"Giex: perfil completo do devedor. Integração direta com TJs. Automação de CDA, penhoras e prazos. iCad: alvarás e licenças digitais (concorrente da Quasar). +15 produtos para governo.", "alerta":"", "url":"https://giex.com.br", "isNew":False},
    {"seg":"proc",   "name":"PGMNET",            "subseg":"Gestão Jurídica Municipal + RPA","porte":"PME",             "loc":"Campos dos Goytacazes - RJ", "fund":"N/D", "presenca":"Procuradorias municipais RJ e outros estados", "receita":"N/D", "nota":"Software jurídico SaaS para procuradorias municipais com automação RPA: peticionamento automático em qualquer TJ do país, captura de publicações e intimações 24/7, gestão de prazos e processos judiciais e administrativos. IA integrada. Desenvolvido co-criação com procuradores. Cases: PGM Campos dos Goytacazes RJ, São Francisco de Itabopoana RJ, São Pedro da Aldeia RJ, COMSERCAF Cabo Frio RJ.", "alerta":"", "url":"https://www.pgmnet.com.br", "isNew":False},
    {"seg":"proc",   "name":"Aetos Tech",        "subseg":"IA Anti-fraude Contratos (Prisma)","porte":"Startup",       "loc":"Brasil",                "fund":"N/D",   "presenca":"MPRJ (CPSI 2024)",        "receita":"Contrato CPSI",    "nota":"Prisma: detecção de irregularidades em contratos públicos e lavagem de dinheiro. Cruzamento de bases abertas por IA. Selecionada CPSI MPRJ.", "alerta":"Contrato CPSI", "url":"https://aetostech.com.br", "isNew":False},
    {"seg":"proc",   "name":"Sumé Tecnologia",   "subseg":"Monitoramento Políticas Públicas (Sonar)","porte":"Startup", "loc":"Brasil",                "fund":"N/D",   "presenca":"MPRJ (CPSI 2024)",        "receita":"Contrato CPSI",    "nota":"Sonar: controle externo automatizado do executivo municipal. Monitora 92 municípios do RJ via MPRJ. Selecionada CPSI MPRJ.", "alerta":"Contrato CPSI", "url":"https://sumetecnologia.com.br", "isNew":False},
    {"seg":"proc",   "name":"Prodata Gestão Estratégica","subseg":"Módulo Procuradoria / ERP Municipal","porte":"PME",  "loc":"Goiânia - GO",          "fund":"N/D",   "presenca":"Municípios Centro-Oeste", "receita":"N/D",              "nota":"Módulo procuradoria integrado ao ERP municipal Prodata. Gestão de contencioso, consultivo e execução fiscal para prefeituras de pequeno e médio porte.", "alerta":"", "url":"https://prodata.com.br", "isNew":False},

    # ── LICITAÇÕES ──
    {"seg":"lic",    "name":"Portal de Compras Públicas","subseg":"Marketplace Licitações Eletrônicas","porte":"Scale-up / PME","loc":"Belo Horizonte - MG","fund":"2016","presenca":"4.000+ entes | 634k+ forn. | +R$616M oportunidades/dia | 300+ processos/dia","receita":"R$450B+ TPV", "nota":"Maior marketplace de licitações do Brasil. 40%+ dos municípios. Fundadores: Leonardo + Bruno Ladeira (Ecustomize). Certificações ISO 9001, 27001, 27701, 20000-1. Integrado ao PNCP. 35% crescimento anual. Portfólio Cedro Capital (FIP Venture Brasil Central) — disponível para M&A, sem mandatada.", "alerta":"M&A Watch — portfólio Cedro", "url":"https://www.portaldecompraspublicas.com.br", "isNew":False},
    {"seg":"lic",    "name":"Licitar.digital",   "subseg":"Plataforma Licitações Eletrônicas / Credenciamento", "porte":"Startup", "loc":"Sete Lagoas - MG", "fund":"Jul/2019", "presenca":"90k+ fornecedores | clientes: Recife PE, Sete Lagoas MG, Itabira MG", "receita":"N/D", "nota":"Plataforma completa de compras públicas conectando entes públicos, fornecedores e cidadãos. Diferencial regulatório em credenciamento eletrônico automatizado. Suporte especializado por telefone, WhatsApp e chat. Compatível com Lei 14.133/2021: pregão eletrônico, dispensa, credenciamento e chamamentos. CEO: Aniele H. Figueiredo.", "alerta":"", "url":"https://licitar.digital", "isNew":False},
    {"seg":"lic",    "name":"StartGi",           "subseg":"Suite B2G para Fornecedores / Gestão de Licitações Sell-side", "porte":"Startup", "loc":"São Paulo - SP", "fund":"2015", "presenca":"50M+ licitações monitoradas", "receita":"N/D", "nota":"Suite SaaS para fornecedores que vendem para governo: i-Ganhei (captação com IA, workflow, propostas automáticas, gestão de contratos), i-Pesquisei (inteligência de mercado B2G), i-Documentei (gestão de certidões), BPO de Licitações e i-One (projetos IA sob medida). Portfólio Fundo GovTech KPTL. 300% mais eficiência declarada.", "alerta":"Portfólio KPTL", "url":"https://startgi.com.br", "isNew":False},
    {"seg":"lic",    "name":"BLL Compras",       "subseg":"Plataforma Licitações Eletrônicas","porte":"PME Estabelecida","loc":"São Paulo - SP",        "fund":"2008",  "presenca":"3.000+ entidades públicas","receita":"N/D",              "nota":"Bolsa de Licitações e Leilões — uma das maiores plataformas de licitações do Brasil. Mais consolidada, pré-startups. Referência histórica do mercado.", "alerta":"", "url":"https://bllcompras.com", "isNew":False},
    {"seg":"lic",    "name":"GoBuyer",           "subseg":"Plataforma SaaS de Cotação e Compras / Compliance Setor Público", "porte":"Startup", "loc":"Brasil", "fund":"N/D", "presenca":"CEB, Onitel e outros | Grupo Squadra", "receita":"N/D", "nota":"Plataforma SaaS 100% flexível de gestão de compras corporativas com IA: cotação, disputas (aberta/fechada/leilão reverso), gestão de contratos, portal do fornecedor e BI de saving. Conformidade 14.133, 13.303 e Pregão Eletrônico. IA Pesquisa de Mercado premiada (Desafio TREM). Parte do Grupo Squadra (venture builder + data intelligence + cybersec). Integra Totvs, SAP, Oracle, Dynamics.", "alerta":"Watch — compras gov", "url":"https://gobuyer.com.br", "isNew":False},
    {"seg":"lic",    "name":"StartGov",          "subseg":"Licitações Buy-side para Órgãos Públicos","porte":"PME",     "loc":"Imperatriz - MA",       "fund":"N/D",   "presenca":"290+ órgãos públicos",    "receita":"N/D",              "nota":"Plataforma buy-side para gestão de licitações e contratos de entes públicos. 290+ órgãos atendidos. Módulos: PCA, Planejamento & Licitação (ETP com IA, Mapa de Riscos), Cotação de Preços (IA + PNCP) e Gestão de Contratação. 100% aderente à Lei 14.133/2021. Metodologia em 5 etapas. Diferente do StartGi (B2G para fornecedores).", "alerta":"Watch — buy-side gov", "url":"https://startgov.com.br", "isNew":False},
    {"seg":"lic",    "name":"Zaelo",             "subseg":"Compras Públicas Buy-side (Órgãos) + Auditoria IA", "porte":"Scale-up", "loc":"Itajaí - SC", "fund":"2016", "presenca":"170+ órgãos públicos | 10K+ servidores públicos", "receita":"N/D (bootstrap)", "nota":"GovTech de compras públicas focada no lado dos órgãos (buy-side). Dois produtos principais: Loja Pública Gestor — cobrindo todo o ciclo (planejamento → execução) com conformidade Lei 14.133/2021; e Sentinela — auditoria inteligente de contratos com IA, detecta anomalias e superfaturamento automaticamente. Até 45% de economia declarada em processos de compras. 170+ órgãos atendidos, 10K+ servidores capacitados. Fundada em 2016, 10 anos de mercado, bootstrap. Sede Itajaí SC.", "alerta":"Watch — buy-side maduro", "url":"https://zaelo.com.br", "isNew":True},
    {"seg":"lic",    "name":"Licito.guru",       "subseg":"IA Buy-side para Licitações em Órgãos Públicos", "porte":"Startup", "loc":"Florianópolis - SC", "fund":"N/D", "presenca":"Pref. São Paulo SP | Gov. Paraná | Gov. Santa Catarina | MP | TJ | Pref. Curitiba PR", "receita":"N/D", "nota":"Plataforma de IA para o lado dos órgãos na contratação pública. Gera automaticamente os principais documentos obrigatórios: ETP (Estudo Técnico Preliminar), DFD (Documento de Formalização de Demanda), TR (Termo de Referência), Mapa de Risco, Edital, Contrato e mais. IA customizável por órgão — aprende os padrões e histórico de cada cliente. Treinada e supervisionada pelo Prof. Gustavo Schiefler (referência nacional em licitações públicas). Carteira com órgãos de alto perfil: Prefeitura de SP, Governos do PR e SC, MP, TJ, Prefeitura de Curitiba. Florianópolis SC.", "alerta":"🔥 Deal — carteira premium", "url":"https://licito.guru", "isNew":True},
    {"seg":"lic",    "name":"Licitagram",        "subseg":"SO de IA Multi-Agente para Licitações (Sell-side + Buy-side)", "porte":"Startup", "loc":"Brasil", "fund":"N/D", "presenca":"200k+ licitações/mês | R$1T+ oportunidades | 67M+ CNPJs cruzados", "receita":"N/D", "nota":"1º Sistema Operacional de IA Multi-Agente para Licitações da América Latina. 14 módulos IA: AI Matching score 0–100, robô de lances IA, inteligência competitiva (5 módulos), pesquisa de preços IN 65/2021, grafo societário, detecção de anomalias, compliance checker e forensic replay. Cobre sell-side (fornecedores) + buy-side (entes públicos) + compliance (TCUs). Integração PNCP. Planos: R$297–R$1.497/mês.", "alerta":"Watch — IA licitações multi-agente", "url":"https://licitagram.com", "isNew":True},
    {"seg":"lic",    "name":"Licitei",           "subseg":"Licitações Sell-side para PMEs", "porte":"Startup", "loc":"Belo Horizonte - MG", "fund":"N/D", "presenca":"4.000+ usuários | 206k+ editais | PNCP integrado", "receita":"R$3,5M (Thompson Participações, jun/2024)", "nota":"Plataforma sell-side focada em PMEs que vendem para governo: robô de lances IA, análise de editais com IA, monitoramento de oportunidades e integração PNCP. Aporte de R$3,5M da Thompson Participações (jun/2024). CEO: Felipe Nardes. 4.000+ usuários ativos, 206k+ editais monitorados. Diferencia-se da StartGi por foco em PMEs e preço acessível.", "alerta":"Watch — sell-side PME", "url":"https://licitei.com.br", "isNew":True},

    # ── HABITAÇÃO & REGULARIZAÇÃO FUNDIÁRIA ──
    {"seg":"hab",    "name":"ReurBR",             "subseg":"SaaS Regularização Fundiária (REURB)",  "porte":"Startup",             "loc":"Brasil (ES, BA, RN)",   "fund":"N/D",   "presenca":"14 municípios | 9.872 títulos emitidos | 17k+ projetos em andamento", "receita":"N/D", "nota":"Plataforma SaaS para regularização fundiária urbana (REURB) ponta a ponta. App offline para coleta de campo. Emissão automática de relatórios técnicos, Títulos de Legitimação e Posse (TLP) e CRF. Integração com cartórios. Reduz 180 dias para 60 dias no processo. Municípios atendidos: Vitória ES, Vila Velha ES, Aracruz ES, Itabuna BA, Parnamirim RN, entre outros. ESG: 100% digital, zero papel.", "alerta":"Watch — REURB nicho virgem", "url":"https://reurbr.com.br", "isNew":False},
    {"seg":"hab",    "name":"sisHABI",             "subseg":"Gestão Habitacional + REURB Municipal", "porte":"PME",                 "loc":"Chapecó - SC",          "fund":"~2007", "presenca":"16 estados brasileiros | MCMV, Casa Verde Amarela, REURB", "receita":"N/D", "nota":"17+ anos como especialista em software para habitação de interesse social: cadastro multifinalitário georreferenciado, seleção de famílias (Portaria 2.081/20), sorteios, auxílio aluguel, cheque-reforma e REURB-S/E com emissão de CRF. Aplicativo móvel online/offline. LGPD-compliant. Equipe multidisciplinar (assistente social, arquiteta, contadora). 100% auditável. Cliente referência: Chapecó SC.", "alerta":"Target roll-up", "url":"https://sishabi.com.br", "isNew":False},
    {"seg":"hab",    "name":"CERURB",              "subseg":"REURB Digital com IA",                  "porte":"Startup",             "loc":"Teresina - PI",         "fund":"N/D",   "presenca":"Municípios + TJ Piauí",   "receita":"N/D",              "nota":"Plataforma corporativa para REURB: diagnóstico, mapeamento geoespacial, emissão automática de CRF e integração com cartórios. 30k+ matrículas abertas em 12 meses. Contratos com Governo do Piauí (PROURBE) e Tribunal de Justiça.", "alerta":"Watch — tração judicial", "url":"https://cerurb.com.br", "isNew":False},
    {"seg":"hab",    "name":"Vivenda",              "subseg":"Plataforma Gerenciadora de Reformas Habitacionais Populares","porte":"Startup de Impacto", "loc":"São Paulo - SP", "fund":"N/D", "presenca":"6.500+ reformas | 40+ cidades | 16 estados | R$54M+ gerenciados", "receita":"N/D", "nota":"Primeira plataforma gerenciadora de reformas habitacionais populares do Brasil. Conecta beneficiários, prestadores e assistentes sociais em sistema único. Parceiros: COHAB-SP (Pode Entrar – Melhorias), Gerdau, Instituto BID, Instituto Cyrela. 24k+ pessoas vivendo melhor. Empresa B certificada. BrazilLAB.", "alerta":"Impacto social / ESG", "url":"https://vivenda.io", "isNew":False},

    # ── MEIO AMBIENTE & LICENCIAMENTO ──
    {"seg":"ambiental","name":"eGAC",          "subseg":"Licenciamento Ambiental Municipal Digital",          "porte":"Startup",             "loc":"Bahia",                 "fund":"~2021", "presenca":"Consórcios intermunicipais BA | CONSID, CONVALE, CDS Bacia do Paramirim", "receita":"N/D", "nota":"Sistema de Gestão Ambiental Compartilhada (eGAC): SaaS de licenciamento ambiental municipal 100% digital. Integra SINAFLOR, GEOBAHIA, SEMA-BA e CEPRAM. Cobrança automática de taxa ambiental via Pix/boleto. 70% redução de custos declarada, onboarding em 30 dias. Nasceu da pandemia de 2021 em colaboração com gestores municipais baianos. Conformidade CEPRAM 4.327/13.", "alerta":"Watch — lic. ambiental nicho virgem", "url":"https://egacapp.com.br", "isNew":False},
    {"seg":"ambiental","name":"TUXTU",         "subseg":"Licenciamento + Arborização + Crédito de Carbono",  "porte":"Startup",             "loc":"Macapá - AP",           "fund":"~2022", "presenca":"Municípios (via órgãos ambientais) | Associada ABES", "receita":"N/D", "nota":"Suite SaaS para Secretarias de Meio Ambiente: SIBLAM (licenciamento com bio-algoritmo e método Battelle EES — reduz subjetividade do analista), SIGAU (arborização urbana com participação cidadã), Sistema de Resíduos Sólidos, Crédito de Carbono (SICCA) e Controle e Fiscalização. Propõe padronização nacional do licenciamento. CEO: Marcelo Creão.", "alerta":"Watch — 3 verticais ambientais", "url":"https://tuxtu.com.br", "isNew":False},
    {"seg":"ambiental","name":"Retech Recycle","subseg":"Gestão de Resíduos Sólidos / Rastreabilidade IoT",  "porte":"Startup early-stage", "loc":"São José dos Campos - SP","fund":"2024", "presenca":"N/D (early-stage)",               "receita":"N/D",              "nota":"Plataforma + hardware IoT proprietário (H-SAT) para rastreabilidade de resíduos sólidos do ponto de coleta ao destino final. Gera documentos auditáveis com fotos georreferenciadas, telemetria e carimbos de tempo. Conformidade PNRS. Modelo híbrido: software + presença onsite. PIT-SJC. Fundada jun/2024.", "alerta":"Watch — PNRS compliance IoT", "url":"https://retechrecycle.com.br", "isNew":False},

    # ── SMART CITIES & MOBILIDADE ──
    {"seg":"smart",    "name":"SmartCityTec",  "subseg":"Plataforma FIWARE / Data Spaces Municipais",  "porte":"Startup", "loc":"Santa Catarina", "fund":"~2022", "presenca":"Smart Mafra + Amurel Conectada (18 mun.) | Membro FIWARE Foundation", "receita":"N/D", "nota":"Plataforma baseada em FIWARE para cidades inteligentes: data spaces interoperáveis, IoT, mobilidade, segurança e clima. Smart Mafra: 1ª cidade BR com lei municipal FIWARE (centraliza tributação, alvarás e todos os serviços públicos em sistema único). Amurel Conectada: integra 18 municípios Região de Laguna/SC — 1º espaço de dados regional BR em operação. SC aprovou Lei 19.494 adotando FIWARE como padrão estadual. CEO: Gilsoni Lunardi Albino. Prêmio Smart City Expo Curitiba 2025 + Barcelona 2025.", "alerta":"Watch — padrão FIWARE em SC", "url":"https://smartcity.tec.br", "isNew":False},
    {"seg":"smart",    "name":"Iguata",        "subseg":"IA para Mobilidade Urbana / Transporte Público",    "porte":"Startup early-stage", "loc":"Porto Alegre - RS",     "fund":"N/D",   "presenca":"N/D (early-stage)",               "receita":"N/D",              "nota":"Plataforma de IA para otimização de redes de transporte público: roteirização dinâmica, previsão de demanda, priorização semafórica e inteligência geoespacial. Resultados declarados: -14% no tempo de viagem (ônibus+IA), -18% custo logístico, +21% satisfação em eventos. Arquitetura modular com API aberta. Early-stage — contratos públicos não confirmados.", "alerta":"Watch — mobilidade pública IA", "url":"https://iguata.com.br", "isNew":False},

    # ── GESTÃO — URBANISMO ──
    {"seg":"gestao", "name":"PLACE",               "subseg":"Planejamento Urbano e Geointeligência / Urban Twin", "porte":"Startup",             "loc":"Brasil",                "fund":"N/D",   "presenca":"Prefeituras e mercado imobiliário privado", "receita":"N/D", "nota":"Plataforma dual (govtech + proptech) de inteligência territorial com Gêmeo Digital: integra bases públicas, rotinas urbanísticas, pré-aprovação de projetos e visualização 2D/3D com IA aplicada à legislação urbanística. Para o setor privado: viabilidade e gestão de portfólio imobiliário. Certificada BrazilLAB.", "alerta":"Watch — urbanismo digital", "url":"https://www.ospa.place", "isNew":False},
]
...
APORTES = [
    ...
    {"tx":"Fundo GovTech — Finep + Fapesp",                     "tipo":"Expansão de fundo", "valor":"R$ 105,7M total", "ano":2025, "data":"out/2025", "seg":"Fundo de Investimento GovTech", "desc":"Fundo GovTech KPTL+Cedro cresce de R$49M para R$105,7M com aportes da Finep (R$40M) e Fapesp (R$30M) em out/2025. Meta para 2026: R$150M. Parceria Prodesp For Startups (SP) para aceleração de startups do portfólio. Portfólio atual: Augen (exit Biosolvit), Prosas, Colab, StartGi, i4Sea, GRTS Digital, Jovens Gênios, Kinebot."},
    {"tx":"Layers — fundo canadense (pré-série A)",           "tipo":"Aporte Pré-Série A", "valor":"R$ 21M", "ano":2025, "data":"set/2025", "seg":"Educação Pública / EdTech", "desc":"SuperApp escolar capta R$21M em pré-série A liderado por fundo canadense. Valuation R$120M. 7.600 escolas públicas (gratuito) + 1.800 privadas. R$1Bi+ transacionado. CEO Danilo Yoneshige. São Caetano do Sul SP."},
    {"tx":"MITRA — Valid (51%)",                                 "tipo":"Aquisição (M&A)", "valor":"N/D", "ano":2025, "data":"2025", "seg":"Gestão Municipal Integrada", "desc":"Valid adquire 51% da MITRA, plataforma de gestão municipal integrada com proposta 'Governo Único para um Cidadão Único'. Cidades atendidas: São Caetano do Sul SP, Santo André SP, Vinhedo SP, Araraquara SP, Campos dos Goytacazes RJ. 1,7M+ cidadãos impactados."},
]
...
<style>
  ...
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .card.fiscal::before    {{ background: var(--gold-dark); }}
  .card.segpub::before    {{ background: var(--slate-dark); }}
  ...
  .card.fiscal     .card-name {{ color: var(--gold-dark); }}
  .card.segpub     .card-name {{ color: var(--slate-dark); }}
  ...
  .card-link      {{ display: inline-flex; align-items: center; gap: 4px; font-size: 10px; font-weight: 600; color: #2E75B6; text-decoration: none; padding: 2px 8px; border-radius: 10px; background: #EEF4FB; border: 1px solid #b8cde0; transition: background 0.15s; }}
  .card-link:hover {{ background: #d6e4f0; }}
...
function makeCard(c) {{
  ...
  const urlHost = c.url ? c.url.replace(/^https?:\/\/(www\.)?/,"").split("/")[0] : "";
  const linkHtml = c.url ? `<a class="card-link" href="${{c.url}}" target="_blank" rel="noopener">🔗 ${{urlHost}}</a>` : "";
