...
COMPANIES = [
    ...
    {"seg":"lic",    "name":"StartGov",          "subseg":"Licitações Buy-side para Órgãos Públicos","porte":"PME",     "loc":"N/D (Brasil)",          "fund":"N/D",   "presenca":"290+ órgãos públicos",    "receita":"N/D",              "nota":"Plataforma buy-side: gestão de licitações e contratos para entes públicos. 290+ clientes. Lei 14.133/2021 compliance. Distinto do StartGi (B2G para fornecedores privados).", "alerta":"Watch — buy-side gov",         "isNew":False},

    # ── HABITAÇÃO & REGULARIZAÇÃO FUNDIÁRIA ──
    {"seg":"hab",    "name":"ReurBR",             "subseg":"SaaS Regularização Fundiária (REURB)",  "porte":"Startup",             "loc":"Brasil (ES, BA, RN)",   "fund":"N/D",   "presenca":"14 municípios | 17k+ un.", "receita":"N/D",              "nota":"Plataforma SaaS para regularização fundiária urbana (REURB) de ponta a ponta. App offline para agentes de campo. Emissão automática de CRF, títulos de legitimação e relatórios técnicos. Integração com cartórios. 17k+ unidades habitacionais regularizadas.", "alerta":"Watch — REURB nicho virgem",   "isNew":False},
    {"seg":"hab",    "name":"sisHABI",             "subseg":"Gestão Habitacional + REURB Municipal", "porte":"PME",                 "loc":"Chapecó - SC",          "fund":"2005",  "presenca":"16 estados brasileiros",  "receita":"N/D",              "nota":"Software especialista em habitação de interesse social e regularização fundiária. 18 anos de atuação. Clientes: Governo de Roraima, programas MCMV e Casa Verde Amarela. Gestão de sorteios, hierarquizações e entregas habitacionais para prefeituras.", "alerta":"Target roll-up",               "isNew":False},
    {"seg":"hab",    "name":"CERURB",              "subseg":"REURB Digital com IA",                  "porte":"Startup",             "loc":"Brasil",                "fund":"N/D",   "presenca":"Municípios + TJ Piauí",   "receita":"N/D",              "nota":"Plataforma corporativa para REURB: diagnóstico, mapeamento geoespacial, emissão automática de CRF e integração com cartórios. 30k+ matrículas abertas em 12 meses. Contratos com Governo do Piauí (PROURBE) e Tribunal de Justiça.", "alerta":"Watch — tração judicial",      "isNew":False},
    {"seg":"hab",    "name":"Vivenda",              "subseg":"Melhoria Habitacional de Interesse Social","porte":"Startup de Impacto", "loc":"São Paulo - SP",        "fund":"N/D",   "presenca":"4.500+ intervenções",     "receita":"N/D",              "nota":"Melhoria habitacional acessível para população de baixa renda. 4.500+ melhorias entregues. Portfólio BrazilLAB. Um dos principais negócios de impacto social do Brasil em habitação.", "alerta":"Impacto social / ESG",         "isNew":False},
